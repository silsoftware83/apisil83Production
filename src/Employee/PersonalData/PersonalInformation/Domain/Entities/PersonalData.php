...
namespace Src\Employee\PersonalData\PersonalInformation\Domain\Entities;
...
final class PersonalData
{
    ...
    public function getDateContractFinish(): ?string
    {
    ...
    public function getIdCheck(): ?string
    {
        return $this->idCheck;
    }
    ...
    public function getPuestoRel(): ?Puesto
    {
    ...
    public function setDateContractFinish(?string $dateContractFinish): void
    {
    ...
    public function setIdCheck(?string $idCheck): void
    {
    ...
    public function setPuestoRel(?Puesto $puestoRel): void
    {
        $this->puestoRel = $puestoRel;
    }

    public function setIngreso(?string $ingreso): void
    {
